...
public enum PSL {
    ...
    COOLDOWN("cooldown",
            ChatColor.GOLD + "Warning: " + ChatColor.GRAY + "Please wait for %time% seconds before placing again!"),
    ...
    FLAG_NOT_SET("flag.flag_not_set",
            ChatColor.AQUA + "%flag%" + ChatColor.GRAY + " flag has " + ChatColor.RED + "not" + ChatColor.GRAY
    ...
    FLAG_GUI_HEADER("flag.gui_header",
            ChatColor.DARK_GRAY + "" + ChatColor.STRIKETHROUGH + "=====" + ChatColor.RESET + " Flags (click to change) "
                    + ChatColor.DARK_GRAY + ChatColor.STRIKETHROUGH + "====="),
    ...
    RENT_PAID_LANDLORD("rent.paid_landlord",
            ChatColor.AQUA + "%tenant%" + ChatColor.GRAY + " has paid " + ChatColor.AQUA + "$%price%" + ChatColor.GRAY
                    + " for renting out " + ChatColor.AQUA + "%region%" + ChatColor.GRAY + "."),
    RENT_PAID_TENANT("rent.paid_tenant",
            ChatColor.GRAY + "Paid " + ChatColor.AQUA + "$%price%" + ChatColor.GRAY + " to " + ChatColor.AQUA
                    + "%landlord%" + ChatColor.GRAY + " for region " + ChatColor.AQUA + "%region%" + ChatColor.GRAY
                    + "."),
    RENT_RENTING_LANDLORD("rent.renting_landlord",
            ChatColor.AQUA + "%player%" + ChatColor.GRAY + " is now renting out region " + ChatColor.AQUA + "%region%"
                    + ChatColor.GRAY + "."),
    RENT_RENTING_TENANT("rent.renting_tenant",
            ChatColor.GRAY + "You are now renting out region " + ChatColor.AQUA + "%region%" + ChatColor.GRAY + " for "
                    + ChatColor.AQUA + "%price%" + ChatColor.GRAY + " per " + ChatColor.AQUA + "%period%"
                    + ChatColor.GRAY + "."),
    ...
    RENT_TENANT_STOPPED_LANDLORD("rent.tenant_stopped_landlord",
            ChatColor.AQUA + "%player%" + ChatColor.GRAY + " has stopped renting out region " + ChatColor.AQUA
    ...
    RENT_EVICT_NO_MONEY_LANDLORD("rent.evict_no_money_landlord",
            ChatColor.AQUA + "%tenant%" + ChatColor.GRAY + " has been " + ChatColor.RED + "evicted" + ChatColor.GRAY
    ...
    TAX_PAID("tax.paid",
            ChatColor.GRAY + "Paid " + ChatColor.AQUA + "$%amount%" + ChatColor.GRAY + " in taxes for region "
                    + ChatColor.AQUA + "%region%" + ChatColor.GRAY + "."),
    TAX_INFO_HEADER("tax.info_header",
            ChatColor.DARK_GRAY + "" + ChatColor.STRIKETHROUGH + "=====" + ChatColor.RESET
                    + " Tax Info (click for more info) " + ChatColor.DARK_GRAY + ChatColor.STRIKETHROUGH + "====="),
    ...
    TAX_PLAYER_REGION_INFO("tax.player_region_info",
            ChatColor.GRAY + "> " + ChatColor.AQUA + "%region%" + ChatColor.GRAY + " - " + ChatColor.DARK_AQUA
                    + "$%money% due"),
    ...
    TAX_REGION_INFO_HEADER("tax.region_info_header",
            ChatColor.DARK_GRAY + "" + ChatColor.STRIKETHROUGH + "=====" + ChatColor.RESET + " %region% Tax Info "
                    + ChatColor.DARK_GRAY + ChatColor.STRIKETHROUGH + "====="),
    ...
    BUY_SOLD_BUYER("buy.sold_buyer",
            ChatColor.GRAY + "Bought region " + ChatColor.AQUA + "%region%" + ChatColor.GRAY + " for " + ChatColor.AQUA
                    + "$%price%" + ChatColor.GRAY + " from " + ChatColor.AQUA + "%player%" + ChatColor.GRAY + "."),
    BUY_SOLD_SELLER("buy.sold_seller",
            ChatColor.GRAY + "Sold region " + ChatColor.AQUA + "%region%" + ChatColor.GRAY + " for " + ChatColor.AQUA
                    + "$%price%" + ChatColor.GRAY + " to " + ChatColor.AQUA + "%player%" + ChatColor.GRAY + "."),
    ...
    SELL_FOR_SALE("sell.for_sale",
            ChatColor.GRAY + "The region is now for sale for " + ChatColor.AQUA + "$%price%" + ChatColor.GRAY + "."),
    ...
    TP_IN_SECONDS("tp.in_seconds",
            ChatColor.GRAY + "Teleporting in " + ChatColor.AQUA + "%seconds%" + ChatColor.GRAY + " seconds."),
    ...
    GET_HEADER("get.header",
            ChatColor.DARK_GRAY + "" + ChatColor.STRIKETHROUGH + "=====" + ChatColor.RESET
                    + " Protect Blocks (click to get) " + ChatColor.DARK_GRAY + ChatColor.STRIKETHROUGH + "====="),
    GET_GUI_BLOCK("get.gui_block",
            ChatColor.GRAY + "> " + ChatColor.AQUA + "%alias% " + ChatColor.GRAY + "- %description% (" + ChatColor.WHITE
    ...
    LIST_HEADER("list.header",
            ChatColor.DARK_GRAY + "" + ChatColor.STRIKETHROUGH + "=====" + ChatColor.RESET + " %player%'s Regions "
                    + ChatColor.DARK_GRAY + ChatColor.STRIKETHROUGH + "====="),
    ...
    LIST_NO_REGIONS_PLAYER("list.no_regions_player",
            ChatColor.AQUA + "%player% " + ChatColor.GRAY + "does not own and is not a member of any regions."),
    ...
    SETPARENT_SUCCESS("setparent.success",
            ChatColor.GRAY + "Successfully set the parent of " + ChatColor.AQUA + "%id%" + ChatColor.GRAY + " to "
                    + ChatColor.AQUA + "%parent%" + ChatColor.GRAY + "."),
    SETPARENT_SUCCESS_REMOVE("setparent.success_remove",
            ChatColor.GRAY + "Successfully removed the parent of " + ChatColor.AQUA + "%id%" + ChatColor.GRAY + "."),
    ...
    MERGE_HEADER("merge.header",
            ChatColor.DARK_GRAY + "" + ChatColor.STRIKETHROUGH + "=====" + ChatColor.RESET
                    + " Merge %region% (click to merge) " + ChatColor.DARK_GRAY + ChatColor.STRIKETHROUGH + "====="),
    ...
    MERGE_AUTO_MERGED("merge.auto_merged",
            ChatColor.GRAY + "Region automatically merged with " + ChatColor.AQUA + "%region%" + ChatColor.GRAY + "."),
    ...
    public static boolean msg(CommandSender p, String str) {
        if (str != null && !str.isEmpty() && p != null) {
            ...
            ProtectionStones.getAdventure().sender(p).sendMessage(MiniMessage.miniMessage().deserialize(mm));
        }
        return true;
    }
    ...
    private static void messageUpgrades(PSL psl, YamlConfiguration yml) {
        ...
        } else if (psl == PSL.REACHED_PER_BLOCK_REGION_LIMIT
                && value.equals("&cYou can not create any more regions of this type.")) {
            yml.set(psl.path, psl.defaultMessage);
    ...
    private static String applyInGameColours(String msg) {
        ...
        while (matcher.find()) {
            ...
            msg = msg.replace(msg.substring(matcher.start(), matcher.end()),
